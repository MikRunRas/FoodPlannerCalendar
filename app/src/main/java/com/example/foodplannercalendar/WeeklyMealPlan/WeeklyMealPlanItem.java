...
@Entity(tableName = "weekly_meals_table")
public class WeeklyMealPlanItem {
    ...
    public WeeklyMealPlanItem(String title, String instructions, String strIngredient1, String strIngredient2, String strIngredient3,
                              ...
                              String strMeasure19, String strMeasure20, String date, String imageUrl){
        this.title = title;
